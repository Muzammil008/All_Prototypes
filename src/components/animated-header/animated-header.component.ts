...
export class AnimatedHeaderComponentClass implements OnInit {
  ...
  // etc
  @Input('opacityFactor') opacityFactor: number = 0;
  ...
  private _setTransitionClasses(scrollTop:number) {
      ...
      if (scrollTop + this._ionHeaderHeight > this._scrollPaddingTop) {
        ...
        this.renderer.addClass(this.fixedMenuButton.nativeElement, 'notvisible');
        ...
        this.renderer.removeClass(this.fixedMenuButton.nativeElement, 'notvisible');
      }
